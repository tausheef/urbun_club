...
export default function Pending() {
  ...
  const fetchPendingDockets = async () => {
    setLoading(true);
    try {
      const result = await activityAPI.getPending();
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-800">Pending Dockets</h1>
          <p className="text-gray-600 mt-1">All dockets in transit or awaiting delivery</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 mb-6">
          <div className="flex gap-3">
            <div className="flex-1 relative">
              <input
                type="text"
                placeholder="Search by Docket No, Consignor, Consignee, Origin, Destination, or Status..."
                value={searchQuery}
        ...
        {loading && (
          <div className="text-center py-12">
            ...
            <p className="mt-4 text-gray-600">Loading pending dockets...</p>
          </div>
        )}
        ...
        {!loading && filteredDockets.length === 0 && (
          <div className="bg-white rounded-lg shadow-sm p-12 text-center">
            <p className="text-gray-500 text-lg">
              {searchQuery
                ? `No pending dockets found matching "${searchQuery}"`
                : 'No pending dockets found'}
            </p>
          </div>
        )}
